...
class Transaksi extends Controller
{
 ...
 {
 //
        $data = KeranjangModel::leftJoin('produk', 'produk.id_produk', '=', 'keranjang.id_produk')->selectRaw('sum(produk.harga * keranjang.jumlah_beli) as total')->first();
        ...
        $saved = $trans->save();
        $all_detail = KeranjangModel::leftJoin('produk', 'produk.id_produk', '=', 'keranjang.id_produk')->select('keranjang.*', 'produk.nama_produk', 'produk.harga')->get();
